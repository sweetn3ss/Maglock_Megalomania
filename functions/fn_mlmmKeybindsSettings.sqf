...
[
	"Maglock Mania",
	"MLMtoPel",
	["Add MLM to Pel","Add MaglockMania to pelican."],
	{
...
// Item spawned for terminal
[
	"MLMMSpawnBox",
	"LIST",
	["Spawned Terminal Object","Chooses which prop to spawn for the terminal."],
	["Maglock Mania","Keybind Settings"],
	[["SignAd_Sponsor_Larkin_F"],["Larkin Aviation"],0],
	0,
	{},
	0
] call CBA_fnc_addSetting;
...
[
	"MLMSupplyPodNum",
	"EDITBOX",
	["Supply Pod Items Number", "Number of the items that will be spawned in the inventory. Number order corresponds with item order above."],
	"Maglock Mania",
